...
[nreltools](https://github.com/andypicke/nreltools) provides functions for working with APIs and tools in the [NREL Developer Network](\https://developer.nrel.gov/) in R. 
